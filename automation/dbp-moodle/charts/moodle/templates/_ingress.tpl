...
comma-separated list of <namespace>-<middleware name>@kubernetes-crd references in list
...
{{- $refs = append $refs (printf "%s-%s@kubernetes-crd" $.Release.Namespace $mw.name) }}
{{- end }}
{{- if $refs }}
